...
/home/srdas/wd/Pfizer/VACIND/scripts/bash/vacind_long_deformable_ITKv4_wb.sh -d \
    -b $BLMPGRAY \
    -c $BLMPGRAY -e MPRAGE \
    -f $FUMPGRAY \
    -g $FUMPGRAY \
...
rm -f  $WORK/ibn_work_wb/ants/antsreg3d0*nii.gz $WORK/ibn_work_wb/ants/antsreg*grid.nii.gz $WORK/ibn_work_wb/futrim_om_to_hw_warped_3d.nii.gz $WORK/ibn_work_wb/futrim_om_to_bltrim*
