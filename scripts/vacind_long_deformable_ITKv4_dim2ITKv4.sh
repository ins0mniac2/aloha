        ...
        "2")  echo "performing 2D deformable registration on corresponding z slices";
            ...
            for ((i=0; i < ${zsize}; i++)) do
             ...
             #     -s 2x1x0vox  -f 4x2x1 | tee $WDIR/ants/ants_output_3d.txt;
                ...
                $BIN_ANTSITK4/antsRegistration --dimensionality 2 $maskopt \
                  -o [ $WDIR/ants/antsreg_${i} , $WDIR/futrim_om_to_hw__warped_${i}_ITKv4.nii.gz ] \
                  -t SyN[ ${ASTEPSIZE?} , $REGUL ] \
                ...
                #  -v -t SyN[${ASTEPSIZE?}] -r $REGUL \
                #  -v -t SyN[0.1,5,0.001] --geodesic 2 -r $REGUL] \
                c3d -mcs $WDIR/ants/antsreg_${i}1Warp.nii.gz -oo $WDIR/ants/antsreg_${i}Warpxvec.nii.gz $WDIR/ants/antsreg_${i}Warpyvec.nii.gz $WDIR/ants/antsreg_${i}Warpzvec.nii.gz                                 
                c3d -mcs $WDIR/ants/antsreg_${i}1InverseWarp.nii.gz -oo $WDIR/ants/antsreg_${i}InverseWarpxvec.nii.gz $WDIR/ants/antsreg_${i}InverseWarpyvec.nii.gz $WDIR/ants/antsreg_${i}InverseWarpzvec.nii.gz          
